...
const Experience = () => {
  return (
    <section
      id="experience"
      className="bg-gradient-to-b from-white to-gray-100 dark:from-slate-900 dark:to-slate-950 text-black dark:text-gray-100 py-16 px-4 md:px-8"
    >
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl font-bold mb-12 text-center text-blue-300 dark:text-blue-400">
        ...
        <div className="space-y-12">
          {experienceData.map((job, index) => (
            <motion.div
              key={index}
              className="bg-white bg-opacity-50 p-8 rounded-xl shadow-2xl backdrop-blur-sm border border-blue-500/10 dark:bg-slate-800 dark:bg-opacity-50 dark:border-blue-400/10"
            ...
            >
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
                <div>
                  <h3 className="text-2xl font-bold text-blue-300 dark:text-blue-400">
                    {job.role}
                  </h3>
