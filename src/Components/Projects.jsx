...
function Projects() {
  ...
  return (
    <section id="projects" className="py-16 px-4 md:px-8 bg-gradient-to-b from-gray-900 to-gray-900 dark:from-slate-900 dark:to-slate-950 text-white dark:text-gray-100">
