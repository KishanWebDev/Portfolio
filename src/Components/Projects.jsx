...
function Projects() {
  const projects = [
    ...
    },
    {
      ...
      image: myntra,
      description:
        "Myntra React Clone: E-Commerce App with React Router, Redux, and Bootstrap",
      features: [
    ...
    >
      ...
      <div className="space-y-16 max-w-6xl mx-auto">
        {projects.map((project, index) => (
          <div
            key={index}
            className="bg-white dark:bg-gray-800 bg-opacity-50 p-8 rounded-xl shadow-2xl hover:shadow-blue-500/100 transition-all duration-300 backdrop-blur-sm border border-blue-500/10"
          >
